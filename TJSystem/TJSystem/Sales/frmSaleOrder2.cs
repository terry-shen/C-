...
namespace TJSystem.Sales
{
	...
	/// Form1 的摘要说明。
	/// </summary>
	public class frmSaleOrder2 : System.Windows.Forms.Form
	{
		...
		public frmSaleOrder2(string sale_so_code)
		{
			//
			// Windows 窗体设计器支持所必需的
			//
			InitializeComponent();
			this._Sale_So_Code = sale_so_code;
			this.txt1.Text = _Sale_So_Code;
...
//			this.txt2.Text = Convert.ToString(Convert.ToInt32(dt.Rows[0]["seq_no"].ToString().Trim()) + 1);
			...
			sb.Append("select pack_qty,so_code,seq_no,item_code,client_itemcode,item_name,item_name_cn,item_desc,item_desc_cn,minorder,item_Qty,unit,");
			...
			sb.Append("where so_code = '"+ this.txt1.Text +"'");
			sb.Append("order by so_code,seq_no");
			this.InitialGrid(sb.ToString());

			priToolBar1.setCurrentForm = this;
			_table = "sale_so_detail";
			_PK = "so_code,seq_no";
			priToolBar1.Initial("sale_so_detail",_PK,sb.ToString());
		...
		private void InitialFormData()
		{
			...
			sql = "select cq_code,cq_code+' '+client_name as client_name from sale_cq_master order by cq_code";
			...
			this.priComboBox4.ValueMember = "cq_code";
			this.priComboBox4.DisplayMember = "client_name";	
		
			sql = "select a.client_itemcode as client_itemcode,a.client_itemcode +' '+c.client_name as client_name from basic_clientItemCode a join basic_item b on a.item_code = b.item_code join basic_client c on c.client_id = a.client_id  ";
			dt = TJSystem.Public.PublicStatic.db.GetDataTable(sql);
			dr = dt.NewRow();
			dr[0] = "";
			dr[1] = "";
			...
			sql = "select a.unit_price as UNIT_PRICE,ltrim(str(a.unit_price,20,2))+' '+b.currency_namecn as UNIT_PRICE_NAME from basic_item_saleprice a left join p_currency b on a.currency=b.currency_code ";
			dt = TJSystem.Public.PublicStatic.db.GetDataTable(sql);
			dr = dt.NewRow();
			dr[0] = 0;
			dt.Rows.InsertAt(dr,0);
			...
			this.priComboBox3.ValueMember = "UNIT_PRICE";
			this.priComboBox3.DisplayMember = "UNIT_PRICE_NAME";
		}
		...
		private bool checkFormValue(string sqltype,System.Text.StringBuilder sb)
		{
			if(sqltype.Equals("insert"))
			{
				...
				if (this.txt2.Text == "")
				{
					MessageBox.Show("货品序号不能为空","Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
					return false;
				}
			...
			if (!TJSystem.Public.PublicStatic.IsNumDouble(this.txt7.Text))
			{
				MessageBox.Show("最小订货量必须为数字","Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
				return false;
			}
			...
			if (!TJSystem.Public.PublicStatic.IsNumDouble(this.txt8.Text))
			{
				MessageBox.Show("订货数量必须为数字","Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
				return false;
			}

			if (!TJSystem.Public.PublicStatic.IsNumDouble(this.txt12.Text))
			{
				MessageBox.Show("折扣必须为数字","Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
				return false;
			}

			if (!TJSystem.Public.PublicStatic.IsNumDouble(this.txt13.Text))
			{
				MessageBox.Show("折扣总数必须为数字","Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
				return false;
			}
		...
		private void AfterButtonClick(string ButtonType)
		{
			...
			{
//				string sql = "select max(seq_no) as seq_no from sale_so_detail where so_code = '"+ _Sale_So_Code +"'";
//				DataTable dt = TJSystem.Public.PublicStatic.db.GetDataTable(sql);
...
//		}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmSaleOrder2));
			...
			// priComboBox3
			// 
			this.priComboBox3.BackColor = System.Drawing.Color.Yellow;
			this.priComboBox3.DataField = "unit_price";
			this.priComboBox3.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.priComboBox3.Font = new System.Drawing.Font("宋体", 10.5F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(134)));
			this.priComboBox3.ItemHeight = 14;
			this.priComboBox3.Location = new System.Drawing.Point(672, 136);
			this.priComboBox3.Name = "priComboBox3";
			this.priComboBox3.Size = new System.Drawing.Size(120, 22);
			this.priComboBox3.TabIndex = 215;
			this.priComboBox3.Visible = false;
			// 
			// priDateTimePicker3
			// 
			...
			this.priTextBox1.DataField = "pack_qty";
			...
			this.priTextBox1.Location = new System.Drawing.Point(696, 80);
			this.priTextBox1.Name = "priTextBox1";
			this.priTextBox1.Size = new System.Drawing.Size(72, 23);
			this.priTextBox1.TabIndex = 206;
			this.priTextBox1.Text = "";
			// 
			// label6
			// 
			...
			this.label6.Location = new System.Drawing.Point(648, 80);
			...
			this.label20.Location = new System.Drawing.Point(456, 104);
			this.label20.Name = "label20";
			this.label20.Size = new System.Drawing.Size(64, 23);
			this.label20.TabIndex = 201;
			this.label20.Text = "折扣金额";
			this.label20.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// txt13
			// 
			this.txt13.BackColor = System.Drawing.Color.Yellow;
			this.txt13.DataField = "discountAmount";
			...
			this.txt13.Location = new System.Drawing.Point(528, 104);
			this.txt13.Name = "txt13";
			this.txt13.Size = new System.Drawing.Size(120, 23);
			this.txt13.TabIndex = 202;
			this.txt13.Text = "";
			// 
			// label17
			// 
			...
			this.label17.Location = new System.Drawing.Point(456, 80);
			...
			this.txt9.Name = "txt9";
			this.txt9.Size = new System.Drawing.Size(120, 23);
			...
			this.label12.Location = new System.Drawing.Point(256, 80);
			...
			this.txt7.Location = new System.Drawing.Point(568, 56);
			this.txt7.Name = "txt7";
			...
			this.priComboBox4.DataField = "cq_code";
			...
			this.priComboBox4.TabIndex = 182;
			...
			this.label34.Location = new System.Drawing.Point(24, 104);
			...
			this.label35.Location = new System.Drawing.Point(288, 104);
			...
			this.label32.Location = new System.Drawing.Point(280, 152);
			...
			this.txt17.Location = new System.Drawing.Point(328, 152);
			this.txt17.Name = "txt17";
			this.txt17.Size = new System.Drawing.Size(320, 23);
			...
			this.txt16.Location = new System.Drawing.Point(528, 128);
			this.txt16.Name = "txt16";
			this.txt16.Size = new System.Drawing.Size(120, 23);
			...
			this.txt15.Size = new System.Drawing.Size(120, 23);
			...
			this.txt14.DataField = "discountType";
			...
			this.txt14.Location = new System.Drawing.Point(96, 104);
			this.txt14.Name = "txt14";
			this.txt14.Size = new System.Drawing.Size(160, 23);
			this.txt14.TabIndex = 129;
			this.txt14.Text = "";
			// 
			// label18
			// 
			...
			this.priTextBox2.DataField = "unit_price";
			...
			this.priTextBox2.Location = new System.Drawing.Point(528, 80);
			this.priTextBox2.Name = "priTextBox2";
			this.priTextBox2.Size = new System.Drawing.Size(120, 23);
			this.priTextBox2.TabIndex = 102;
			this.priTextBox2.Text = "";
			// 
			// lk_detail
			// 
			...
			this.Name = "frmSaleOrder2";
			this.ShowInTaskbar = false;
			this.Text = "销售订单";
			this.Closed += new System.EventHandler(this.frmSaleOrder2_Closed);
...
//				e.Cancel = true;
//			}
			string sql = "select sum(discountamount) as totalamount from sale_so_detail where so_code='" + this.txt1.Text + "'";
			DataTable dt = TJSystem.Public.PublicStatic.db.GetDataTable(sql);
			if(dt.Rows.Count == 1)
			{
...
//				else
//				{
//					frmAddSoItem frmASI = new frmAddSoItem(this.txt1.Text.ToString().Trim());
//					frmASI.Show();
...
//			DataTable dt = TJSystem.Public.PublicStatic.db.GetDataTable(sql);
//			this.priComboBox11.DataSource = dt.DefaultView;
...
//		}
		...
		private void frmSaleOrder2_Closed(object sender, System.EventArgs e)
		{
			frmSaleOrder.Count = 0;
		}

		private void priComboBox1_SelectionChangeCommitted(object sender, System.EventArgs e)
		{
			if(this.priComboBox1.SelectedValue.ToString().Equals(""))
			{
				return ;
			}
			...
			sql = "select a.unit_price as UNIT_PRICE,ltrim(str(a.unit_price,20,2))+' '+b.currency_namecn as UNIT_PRICE_NAME from basic_item_saleprice a left join p_currency b on a.currency=b.currency_code where a.item_code = '"+ this.priComboBox1.SelectedValue +"' ";
			dt = TJSystem.Public.PublicStatic.db.GetDataTable(sql);
			dr = dt.NewRow();
			dr[0] = 0;
			dt.Rows.InsertAt(dr,0);
			...
			if(dt.Rows.Count == 1)
			{
				...
				this.txt9.Text = dt.Rows[0]["unit"].ToString().Trim();
				this.txt15.Text = dt.Rows[0]["outsidepack"].ToString().Trim();
				this.txt16.Text = dt.Rows[0]["insidepack"].ToString().Trim();
		...
		private void priComboBox4_SelectionChangeCommitted(object sender, System.EventArgs e)
		{
			...
			System.Text.StringBuilder sb = new System.Text.StringBuilder();
			sb.Append("select a.cq_code,a.seq_no,a.item_code,b.item_name,b.item_name_cn,b.item_desc,b.item_desc_cn,");
			sb.Append(" b.minorder,b.unit,b.outsidepack,b.insidepack,");
			sb.Append(" a.item_qty,a.unit_price,a.pack_qty");
			sb.Append(" from sale_cq_deatil a");
			sb.Append(" left join basic_item b on a.item_code=b.item_code");
			sb.Append(" where a.cq_code=");
			sb.Append("'");
			sb.Append(this.priComboBox4.SelectedValue.ToString().Trim());
			sb.Append("'");
			...
			sql = "select case when max(seq_no) is null then 0 else max(seq_no) end as counts from sale_so_detail where so_code='" + this.txt1.Text + "'";
			...
			{				
				int icount = 0;
				db.BeginTrans();
				sql = "delete from sale_so_detail where so_code='" + this.txt1.Text + "' and cq_code='" + this.priComboBox4.SelectedValue.ToString() + "'";;
				db.ExeSql(sql);
				for(int i = 0; i < dt.Rows.Count ; i++)
				{
					sb.Remove(0,sb.ToString().Length);
					sb.Append(" insert into sale_so_detail(so_code,seq_no,cq_code,item_code,item_name,item_name_cn,item_desc,item_desc_cn,minorder,unit,outsidepack,insidepack,unit_price,item_qty,pack_qty) values (");
					sb.Append("'");
					sb.Append(this.txt1.Text.Trim());
					sb.Append("','");
					sb.Append(Convert.ToString(Convert.ToInt32(dttmp.Rows[0][0].ToString()) + i+1));
					sb.Append("','");
					sb.Append(dt.Rows[i]["cq_code"].ToString());
					sb.Append("','");
					...
					sb.Append("','");
					sb.Append(dt.Rows[i]["outsidepack"].ToString());
					sb.Append("','");
					sb.Append(dt.Rows[i]["insidepack"].ToString());
					sb.Append("','");
					sb.Append(dt.Rows[i]["unit_price"].ToString());
					sb.Append("','");
					sb.Append(dt.Rows[i]["item_qty"].ToString());
					sb.Append("','");
					sb.Append(dt.Rows[i]["pack_qty"].ToString());
					sb.Append("')");
		...
		private void InitialFormDataWithDataGridFunc()
		{
			...
			this.priComboBox3.ValueMember = "UNIT_PRICE";
			this.priComboBox3.DisplayMember = "UNIT_PRICE_NAME";
			this.priComboBox2.SelectedValue = ((System.Data.DataView)this.dataGrid1.DataSource)[this.dataGrid1.CurrentRowIndex]["UNIT_PRICE"].ToString();
		}
	}
}
