...
namespace TJSystem.Report
{
	...
	/// frmRptBalance 的摘要说明。
	/// </summary>
	public class frmRptSaleHis : System.Windows.Forms.Form
	{
		/// <summary>
		/// 必需的设计器变量。
		/// </summary>
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			{
				sbcondition.Append(" and a.so_code =");
				sbcondition.Append("'");
				sbcondition.Append(this.textBox1.Text.Trim());
				sbcondition.Append("'");
			}

			sbcondition.Append(" and a.so_date >= ");
			sbcondition.Append("'");
			...
			sb.Append("select a.so_code,a.so_date,a.status,b.status_name as status_name,a.client_name,a.amount,a.createby,a.fobamount,a.client_orderno");
...
//			else
			{
				...
				TJSystem.Public.PublicStatic.formName = "销售记录";
			}
			base.OnClosing (e);
		}
