...
namespace TJSystem.Account
{
	/// <summary>
	/// </summary>
	public class frmPaymentBillBalance : System.Windows.Forms.Form
	{
		...
		public frmPaymentBillBalance()
		{
			...
			sb.Append(" from finance_pba_master");
			sb.Append(" order by pba_code");
			this.InitialGrid(sb.ToString());
			priToolBar1.setCurrentForm = this;
			priToolBar1.Initial("finance_pba_master","pba_code",sb.ToString());
		...
		{		
			DataTable dt = TJSystem.Public.PublicStatic.db.GetDataTable(sql);
			dt.TableName = "finance_pba_master";
...
//			else
			{
				...
				TJSystem.Public.PublicStatic.formName = "付款单冲销应付单";
			}
			base.OnClosing (e);
		}
		#region Windows Form 
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmPaymentBillBalance));
			...
			this.dataGrid1.Size = new System.Drawing.Size(783, 296);
			...
			this.dateTimePicker1.DataField = "pba_date";
			this.dateTimePicker1.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
			this.dateTimePicker1.Location = new System.Drawing.Point(374, 15);
			...
			this.priTextBox9.Location = new System.Drawing.Point(374, 136);
			...
			this.label22.Location = new System.Drawing.Point(272, 136);
			...
			this.priTextBox8.Location = new System.Drawing.Point(374, 112);
			...
			this.priTextBox3.Size = new System.Drawing.Size(408, 23);
			...
			this.priTextBox7.Location = new System.Drawing.Point(374, 40);
			...
			this.label12.Location = new System.Drawing.Point(278, 40);
			...
			this.priTextBox2.DataField = "supplier_name";
			...
			this.priTextBox2.Size = new System.Drawing.Size(408, 23);
			...
			this.label2.Text = "冲销单号";
			this.label2.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// priTextBox1
			// 
			this.priTextBox1.DataField = "pba_code";
			...
			this.Name = "frmPaymentBillBalance";
			this.Text = "付款单冲销应付单";
		...
		{
			priTextBox2.Text=comboBox1.SelectedValue.ToString();
		}
