...
namespace TJSystem.Account
{
	...
	/// </summary>
	public class frmFreightPaymentBillBalance : System.Windows.Forms.Form
	{
		...
		public frmFreightPaymentBillBalance()
		{
			InitializeComponent();
			...
			sb.Append(" from finance_aba_master");
		...
		{
			if(TJSystem.Public.PublicStatic.IsNumeric(priTextBox1.ToString())==false)
			{
				TJSystem.Public.PublicStatic.ShowMessage(TJSystem.Public.MessageType.Error,"付款单号必须为数字!");
				return false;
			}
			if(TJSystem.Public.PublicStatic.IsNumeric(priTextBox7.ToString())==false)
			{
				TJSystem.Public.PublicStatic.ShowMessage(TJSystem.Public.MessageType.Error,"付款单号必须为数字!");
				return false;
			}
...
//			else
			{
				...
				TJSystem.Public.PublicStatic.formName = "运费付款单冲销应付运费单";
			}
			base.OnClosing (e);
		}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFreightPaymentBillBalance));
			...
			this.label14.Location = new System.Drawing.Point(35, 112);
			...
			// priTextBox7
			// 
			this.priTextBox7.DataField = "Amount";
			...
			this.Name = "frmFreightPaymentBillBalance";
			this.Text = "运费付款单冲销应付运费单";
