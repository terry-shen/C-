...
namespace TJSystem.Account
{
	...
	/// Form1 的摘要说明。
	/// </summary>
	public class frmGatheringBillDetail : System.Windows.Forms.Form
	{
		...
		public frmGatheringBillDetail(string ga_code)
		{
			//
			// Windows 窗体设计器支持所必需的
			//
			...
			this.txt1.Text = ga_code;
			InitialFormData();

			System.Text.StringBuilder sb = new System.Text.StringBuilder();
			sb.Append("select ga_code,seq_no,ref_code,amount,remark  ");
			sb.Append(" from finance_gathering_detail a");
			sb.Append(" where a.ga_code=");
			sb.Append("'");
			sb.Append(ga_code);
			sb.Append("'");
			...
			_table = "finance_gathering_detail";
			_PK = "ga_code,seq_no";
		...
		private void InitialFormData()
		{
			...
			DataRow dr = null;
			sql = "select so_code,so_code + ' ' + so_date as so_desc from sale_so_master where status > 0 order by so_code";
			...
			this.priComboBox2.ValueMember = "so_code";
			this.priComboBox2.DisplayMember = "so_desc";
		}
		...
		{		
			...
			dt.TableName = "finance_gathering_detail";
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmGatheringBillDetail));
			...
			this.dataGridTableStyle1.MappingName = "finance_gathering_detail";
			...
			this.ga_code.HeaderText = "收款单号";
			this.ga_code.MappingName = "ga_code";
			this.ga_code.NullText = "";
			...
			this.Name = "frmGatheringBillDetail";
