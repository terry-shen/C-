...
namespace TJSystem.Stock
{
	...
	/// Form1 的摘要说明。
	/// </summary>
	public class frmStockChangeOutList : System.Windows.Forms.Form
	{
		...
		public frmStockChangeOutList(string ti_code)
		{
			//
			// Windows 窗体设计器支持所必需的
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmStockChangeOutList));
			...
			this.Name = "frmStockChangeOutList";
