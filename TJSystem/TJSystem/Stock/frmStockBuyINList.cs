...
namespace TJSystem.Stock
{
	...
	/// Form1 的摘要说明。
	/// </summary>
	public class frmStockBuyINList : System.Windows.Forms.Form
	{
		...
		public frmStockBuyINList(string ti_code)
		{
			//
			// Windows 窗体设计器支持所必需的
			//
			...
			sb.Append("select a.stock_code,a.event_type,a.seq_no,a.PSO_code,a.item_code,a.item_name_cn,a.item_desc_cn,a.unit,a.item_Qty,d.unit_name_cn, ");
		...
		private bool checkFormValue(string sqltype)
		{
			if(sqltype.Equals("insert"))
			{
				...
				{
					TJSystem.Public.PublicStatic.ShowMessage(TJSystem.Public.MessageType.Exclamation,"已存在该笔记录，请确认！");
					return false;
				}
			}	
			return true;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmStockBuyINList));
			...
			this.priTextBox1.Location = new System.Drawing.Point(680, 216);
			this.priTextBox1.Name = "priTextBox1";
			this.priTextBox1.Size = new System.Drawing.Size(88, 23);
			this.priTextBox1.TabIndex = 178;
			this.priTextBox1.Text = "BUY";
			// 
			// priComboBox2
			// 
			...
			this.label15.Location = new System.Drawing.Point(432, 144);
			...
			this.txt15.Location = new System.Drawing.Point(520, 144);
			this.txt15.Name = "txt15";
			this.txt15.Size = new System.Drawing.Size(248, 23);
...
//			}
		...
		private void priComboBox4_SelectionChangeCommitted(object sender, System.EventArgs e)
		{
			...
			{
				TJSystem.Public.PublicStatic.ShowMessage(TJSystem.Public.MessageType.Exclamation,"采购单不存在，无法导入采购明细！");
				return;
			}

			System.Text.StringBuilder sb = new System.Text.StringBuilder();
			sb.Append("select a.po_code,a.seq_no,a.item_code,a.item_name,b.item_name_cn,a.item_desc,b.item_desc_cn,");
			...
			if(dt.Rows.Count == 0)
			{
				TJSystem.Public.PublicStatic.ShowMessage(TJSystem.Public.MessageType.Exclamation,"该采购单无货品资料！");
				return;
			}

			if(MessageBox.Show("是否需要导入该采购单的货品资料？","确认导入",MessageBoxButtons.YesNo,MessageBoxIcon.Question)
			...
			{				
				int icount = 0;
				db.BeginTrans();
				sql = "delete from wip_stock_det where stock_code='" + this.txt1.Text + "' and pso_code='" + this.priComboBox4.SelectedValue.ToString() + "'";
				sql += " and event_type='" + _eventtype + "'";
				db.ExeSql(sql);
				for(int i = 0; i < dt.Rows.Count ; i++)
				{
					...
					sb.Append("','");
					sb.Append(dt.Rows[i]["po_code"].ToString());
					sb.Append("','");
