...
namespace TJSystem.Stock
{
	...
	/// Form1 的摘要说明。
	/// </summary>
	public class frmStockSellOutList : System.Windows.Forms.Form
	{
		...
		private TJSystem.Classes.PriTextBox priTextBox100;
		private string _eventtype = null;

		public frmStockSellOutList(string ti_code)
		{
			//
			// Windows 窗体设计器支持所必需的
			//
			...
			sb.Append("select a.stock_code,a.seq_no,a.event_type,a.PSO_code,a.item_code,a.item_name_cn,a.item_desc_cn,a.outsiepacktype,b.pack_method_name,");
			sb.Append(" a.insidepacktype,c.pack_namecn,a.item_qty,a.unit,a.remark,a.unit_price,d.unit_name_cn");
		...
		private void InitialFormData()
		{
			...
			sql = "select SO_CODE,SO_CODE+' '+SO_DATE as SO_DESC from sale_so_master order by SO_CODE";
			dt = TJSystem.Public.PublicStatic.db.GetDataTable(sql);
			dr = dt.NewRow() ;
			dr[0] = "" ;
			dr[1] = "" ;
			...
			this.priComboBox5.ValueMember = "SO_CODE";
			this.priComboBox5.DisplayMember = "SO_DESC";	
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmStockSellOutList));
			...
			this.priTextBox100 = new TJSystem.Classes.PriTextBox();
			...
			this.dataGrid1.CaptionText = "出库单列表";
			...
			this.panel4.Controls.Add(this.priTextBox100);
			...
			// priTextBox100
			// 
			this.priTextBox100.BackColor = System.Drawing.Color.White;
			this.priTextBox100.DataField = "event_type";
			this.priTextBox100.DataType = TJSystem.Public.DataType.String;
			this.priTextBox100.Font = new System.Drawing.Font("宋体", 10.5F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(134)));
			this.priTextBox100.Location = new System.Drawing.Point(96, 184);
			this.priTextBox100.Name = "priTextBox100";
			this.priTextBox100.Size = new System.Drawing.Size(120, 23);
			this.priTextBox100.TabIndex = 177;
			this.priTextBox100.Text = "SELL";
			// 
			// priComboBox2
			// 
			...
			this.priComboBox2.Location = new System.Drawing.Point(312, 120);
			...
			this.priComboBox3.Location = new System.Drawing.Point(96, 120);
			...
			this.txt14.Size = new System.Drawing.Size(120, 23);
			...
			this.label25.Location = new System.Drawing.Point(256, 96);
			...
			this.label24.Location = new System.Drawing.Point(488, 72);
			...
			this.txt11.Location = new System.Drawing.Point(568, 72);
			this.txt11.Name = "txt11";
			this.txt11.Size = new System.Drawing.Size(192, 23);
			...
			this.label18.Location = new System.Drawing.Point(224, 120);
			this.label18.Name = "label18";
			this.label18.Size = new System.Drawing.Size(80, 23);
			this.label18.TabIndex = 126;
			this.label18.Text = "外包装类型";
			...
			this.txt7.Location = new System.Drawing.Point(312, 72);
			this.txt7.Name = "txt7";
			...
			this.label20.Location = new System.Drawing.Point(496, 96);
			...
			this.txt16.Location = new System.Drawing.Point(568, 96);
			this.txt16.Name = "txt16";
			this.txt16.Size = new System.Drawing.Size(192, 23);
			...
			this.txt2.Location = new System.Drawing.Point(312, 48);
			this.txt2.Name = "txt2";
			...
			this.txt15.Size = new System.Drawing.Size(664, 23);
			...
			this.priComboBox4.Location = new System.Drawing.Point(312, 96);
			this.priComboBox4.Name = "priComboBox4";
			this.priComboBox4.Size = new System.Drawing.Size(160, 22);
			this.priComboBox4.TabIndex = 176;
			// 
			// priComboBox5
			// 
			this.priComboBox5.BackColor = System.Drawing.Color.White;
			this.priComboBox5.DataField = "PSO_code";
			this.priComboBox5.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.priComboBox5.Location = new System.Drawing.Point(568, 48);
			this.priComboBox5.Name = "priComboBox5";
			this.priComboBox5.Size = new System.Drawing.Size(192, 22);
			this.priComboBox5.TabIndex = 176;
...
//			}
		...
		private void priComboBox5_SelectionChangeCommitted(object sender, System.EventArgs e)
		{
			...
			{
				TJSystem.Public.PublicStatic.ShowMessage(TJSystem.Public.MessageType.Exclamation,"销售单不存在，无法导入销售明细！");
				return;
			}

			System.Text.StringBuilder sb = new System.Text.StringBuilder();
			sb.Append("select a.so_code,a.seq_no,a.item_code,a.item_name,b.item_name_cn,a.item_desc,b.item_desc_cn,");
			sb.Append(" case when a.item_qty is null then 0 else a.item_qty end as item_qty,a.unit,");
			sb.Append(" case when a.unit_price is null then 0 else a.unit_price end as unit_price ");
			sb.Append(" from sale_so_detail a");
			sb.Append(" left join basic_item b on a.item_code=b.item_code");
			sb.Append(" where a.so_code=");
			sb.Append("'");
			sb.Append(this.priComboBox5.SelectedValue.ToString().Trim());
			sb.Append("'");
			sb.Append(" order by a.seq_no");
			...
			if(dt.Rows.Count == 0)
			{
				TJSystem.Public.PublicStatic.ShowMessage(TJSystem.Public.MessageType.Exclamation,"该销售单无货品资料！");
				return;
			}

			if(MessageBox.Show("是否需要导入该销售单的货品资料？","确认导入",MessageBoxButtons.YesNo,MessageBoxIcon.Question)
			...
			sql = "select case when max(seq_no) is null then 0 else max(seq_no) end as counts from wip_stock_det where stock_code='" + this.txt1.Text + "'";
			sql += " and event_type='" + _eventtype + "'";
			...
			{				
				int icount = 0;
				db.BeginTrans();
				sql = "delete from wip_stock_det where stock_code='" + this.txt1.Text + "' and pso_code='" + this.priComboBox5.SelectedValue.ToString() + "'";;
				sql += " and event_type='" + _eventtype + "'";
				db.ExeSql(sql);
				for(int i = 0; i < dt.Rows.Count ; i++)
				{
					sb.Remove(0,sb.ToString().Length);
					sb.Append(" insert into wip_stock_det(event_type,stock_code,seq_no,pso_code,item_code,item_name,item_name_cn,item_desc,item_desc_cn,item_qty,unit,unit_price) values (");
					sb.Append("'");
