...
namespace TJSystem.Doc
{
	...
	/// Form1 的摘要说明。
	/// </summary>
	public class frmAwbDocDetail : System.Windows.Forms.Form
	{
		...
		public frmAwbDocDetail(string sale_so_code,string awbno)
		{
			//
			// Windows 窗体设计器支持所必需的
			//
			...
			sb.Append("where so_code in ("+ sale_so_code +")");
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmAwbDocDetail));
			...
			this.comboBox1.Items.AddRange(new object[] {
														   "FREIGHT COLLECT",
														   "FREIGHT PREPAID"});
			this.comboBox1.Location = new System.Drawing.Point(424, 480);
			this.comboBox1.Name = "comboBox1";
			this.comboBox1.Size = new System.Drawing.Size(152, 22);
			this.comboBox1.TabIndex = 5;
			this.comboBox1.Text = "FREIGHT COLLECT";
			// 
			// label2
			// 
			this.label2.BackColor = System.Drawing.Color.Transparent;
			this.label2.Location = new System.Drawing.Point(352, 480);
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(144, 472);
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			sql = "select a.invoice_no,a.FREIGHT_PAYTYPE,a.loadingterm,a.* from SALE_WAYBILL_MASTER a where a.awb_code='" + this._awbNo + "'";
			...
			dpcom.PKCondition = " where a.so_code in ("+ this._Sale_So_Code +")";
			dpcom.DocNO = this._awbNo;
			dpcom.Remark = this.comboBox1.Text;
			if (dt.Rows.Count > 0)
			{
				dpcom.DocLCNO = dt.Rows[0]["invoice_no"].ToString().Trim();
				dpcom.PayType = dt.Rows[0]["FREIGHT_PAYTYPE"].ToString().Trim();
				dpcom.ShipperType = dt.Rows[0]["loadingterm"].ToString().Trim();
			}
			
			TJSystem.CrystalRPT.frmReport frm = new TJSystem.CrystalRPT.frmReport("货物托运单",dpcom,this.dataGrid1);
