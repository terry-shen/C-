...
namespace TJSystem.Systems
{
	...
	/// </summary>
	public class frmBrmFlowDet : System.Windows.Forms.Form
	{
		...
		public frmBrmFlowDet()
		{
			...
			sb.Append("select flow_id,flow_name,flow_desc,createby,createon,modifyby,modifyon from brm_flow_det order by flow_id");
...
//			this.comboBox1.DisplayMember = "COMPANY_NAME_CN";
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmBrmFlowDet));
			...
			this.flow_desc = new System.Windows.Forms.DataGridTextBoxColumn();
			...
			this.dataGrid1.Size = new System.Drawing.Size(784, 344);
			...
			// flow_desc
			// 
			this.flow_desc.Format = "";
			this.flow_desc.FormatInfo = null;
			this.flow_desc.HeaderText = "流程描述";
			this.flow_desc.MappingName = "flow_desc";
			this.flow_desc.NullText = "";
			this.flow_desc.Width = 75;
			// 
			// createBy
			// 
			...
			this.priTextBox2.Location = new System.Drawing.Point(432, 80);
			...
			this.priTextBox1.Location = new System.Drawing.Point(432, 56);
			...
			this.label15.Location = new System.Drawing.Point(32, 56);
			...
			this.priTextBox11.Location = new System.Drawing.Point(120, 56);
			...
			this.priTextBox8.Location = new System.Drawing.Point(120, 80);
			...
			this.priTextBox4.DataField = "flow_desc";
			...
			this.textBox1.DataField = "flow_id";
			...
			this.priTextBox3.DataField = "flow_name";
