...
namespace TJSystem.Systems
{
	...
	/// Form1 的摘要说明。
	/// </summary>
	public class frmSysCompanyBank : System.Windows.Forms.Form
	{
		...
		public frmSysCompanyBank(string companyid)
		{
			//
			// Windows 窗体设计器支持所必需的
			//
			...
			this.priTextBox2.Text = companyid;
			System.Text.StringBuilder sb = new System.Text.StringBuilder();
			sb.Append("select company_id,bank_id,bank_name,account,country,province,city,postcode,address,swift_code,createby,createon,modifyby,modifyon ");
			sb.Append("from basic_company_bank ");
			...
			_table = "basic_company_bank";
			_PK = "company_id,bank_id";
		...
		{		
			...
			dt.TableName = "basic_company_bank";
