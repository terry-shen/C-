...
namespace TJSystem.Clients
{
	...
	/// Form1 的摘要说明。
	/// </summary>
	public class frmClientSuplierContact : System.Windows.Forms.Form
	{
		...
		private TJSystem.Classes.PriTextBox priTextBox111;
		...
		public frmClientSuplierContact(string supplierid)
		{
			//
			// Windows 窗体设计器支持所必需的
			//
			...
			this.priTextBox1.Text = supplierid;
			InitialFormData();
			System.Text.StringBuilder sb = new System.Text.StringBuilder();
			sb.Append("select a.supplier_id,a.contact_id,a.contact_name,a.gender,a.department,a.position,a.tel,a.fax,a.mobile,a.email,a.status,b.status_name as status_name,a.qq_no ");
			sb.Append(" from basic_supplier_contact a");
			...
			_table = "basic_supplier_contact";
			_PK = "supplier_id,contact_id";
...
//				this.priTextBox1.Enabled = true;
		...
		{		
			...
			dt.TableName = "basic_supplier_contact";
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmClientSuplierContact));
			...
			this.dataGrid1.CaptionText = "供应商联系方式";
			...
			this.dataGridTableStyle1.MappingName = "basic_supplier_contact";
			...
			this.label1.Text = "供应商联系方式";
			this.label1.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// frmClientSuplierContact
			// 
			...
			this.Name = "frmClientSuplierContact";
