...
namespace TJSystem.Clients
{
	...
	/// Form1 的摘要说明。
	/// </summary>
	public class frmClientSuplierBank : System.Windows.Forms.Form
	{
...
//		private TJSystem.Classes.PriTextBox priTextBox111;
		...
		public frmClientSuplierBank(string supplier)
		{
			//
			// Windows 窗体设计器支持所必需的
			//
			...
			sb.Append("select supplier_id,bank_id,bank_name,account,country,province,city,postcode,address,swift_code ");
			sb.Append("from basic_supplier_bank ");
			sb.Append("where supplier_id='");
			sb.Append(supplier);
			sb.Append("' order by bank_id");
			this.InitialGrid(sb.ToString());
			//			this.textBox1.DataField = "PNO";
			priToolBar1.setCurrentForm = this;
			_table = "basic_supplier_bank";
			_PK = "supplier_id,bank_id";
...
//				this.priTextBox1.Enabled = true;
		...
		{		
			...
			dt.TableName = "basic_supplier_bank";
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmClientSuplierBank));
			...
			this.dataGrid1.Size = new System.Drawing.Size(576, 184);
			...
			this.dataGridTableStyle1.MappingName = "basic_supplier_bank";
			...
			this.Name = "frmClientSuplierBank";
