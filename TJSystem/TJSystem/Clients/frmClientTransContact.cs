...
namespace TJSystem.Clients
{
	...
	/// Form1 的摘要说明。
	/// </summary>
	public class frmClientTransContact : System.Windows.Forms.Form
	{		
		/// <summary>
		/// 必需的设计器变量。
		/// </summary>
		...
		{		
			...
			dt.TableName = "basic_forwarder_contact";
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmClientTransContact));
			...
			this.dataGrid1.CaptionText = "运输商联系方式";
			...
			this.dataGridTableStyle1.MappingName = "basic_forwarder_contact";
			...
			this.priTextBox2.DataField = "forwarder_id";
			...
			this.label1.Text = "运输商联系方式";
			this.label1.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// frmClientTransContact
			// 
			...
			this.Name = "frmClientTransContact";
